...
14.3%): vulnerability 14.0, group size 12.8, gain 14.6, outcome 14.8, directness 14.1, context 14.5,
stakeholder 15.2.

**Known consequence (a finding, not a bug in the recipe).** With every refusal button equally likely,
...
The underlying issue is the donation signal's "any click counts in full" rule; it is recorded in
`docs/FRESH_EYE_AUDIT.md` for a separate decision.
